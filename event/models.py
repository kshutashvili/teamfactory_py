...
class ConfigurationEventsPopUp(SingletonModel):
	text_where  = models.CharField(max_length=20 , verbose_name='Блок где' , default='Где')
	text_when  = models.CharField(max_length=20 , verbose_name='Блок Когда' , default='Когда')
	text_lector  = models.CharField(max_length=20 , verbose_name='Блок автора' , default='Автор')
